...
var Boid = function() {
	...
	function init() {
		...
		for ( var i = 0; i < 200; i ++ ) {
			...
			boid.position.x = Math.random() * 1000 - 200;
			boid.position.y = Math.random() * 1000 - 200;
			boid.position.z = Math.random() * 1000 - 200;
			boid.velocity.x = Math.random() * 2 - 1;
			boid.velocity.y = Math.random() * 2 - 1;
			boid.velocity.z = Math.random() * 2 - 1;
			boid.setAvoidWalls( true );
			boid.setWorldSize( 1000, 1000, 200);		//this defines how many birds you want and how big 												//the screen would be
	...
	function render() {
		...
		for ( var i = 0, il = birds.length; i < il; i++ ) {
			...
			color.r = color.g = color.b = ( 700 - bird.position.z ) / 1000;
